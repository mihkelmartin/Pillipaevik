...
public class LooTestAndmedUI {
    ...
    public void looTeosedHarjutused() {
        TestTooriistad.LisaTeosUI("Testteos I", "Mihkel Martin", "Minu loodud lugu");
            TestTooriistad.LisaHarjutusUI("Testteos I Harjutus I", 60, 5);
            TestTooriistad.VajutaTagasiKui1Fragment();
            TestTooriistad.LisaHarjutusUI("Testteos I Harjutus II", 50, 5);
            TestTooriistad.VajutaTagasiKui1Fragment();
        TestTooriistad.VajutaTagasiKui1Fragment();

        TestTooriistad.LisaTeosUI("Testteos II", "Oskar Martin", "Oskari loodud lugu");
            TestTooriistad.LisaHarjutusUI("Testteos II Harjutus I", 60, 5);
            TestTooriistad.VajutaTagasiKui1Fragment();
        ...
        TestTooriistad.LisaHarjutusUI("Testteos III Harjutus I", 60, 5);
        TestTooriistad.VajutaTagasiKui1Fragment();
        TestTooriistad.LisaHarjutusUI("Testteos III Harjutus II", 50, 5);
        TestTooriistad.VajutaTagasiKui1Fragment();
    }
}
